...
class ResponseMsgs:
    ...
    CONTACT = "If you have any suggestions or find a bug, please send an email to this address: " \
    ...
    BAD_URL = emojize(
        "Sorry, that url can't be shortened. :pensive: The url is most likely invalid.")
